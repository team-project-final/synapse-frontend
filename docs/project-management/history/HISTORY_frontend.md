...
| 날짜 | 변경 사항 |
|------|-----------|
| 2026-06-16 | Knowledge 노트 아웃링크 API 연동(5b): fetchOutlinks datasource·usecase·`outlinksProvider`, 상세화면 아웃링크 섹션 추가(백링크 헬퍼 공용화). analyze 0·위젯테스트 14/14. 상세 [REPORT.md](../../REPORT.md) |
