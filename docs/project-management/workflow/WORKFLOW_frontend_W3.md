...
**Step 8 Status**: [x] Done (PR #37 인박스·읽음·뱃지·설정 + 이슈 #20 잔여분: 30초 폴링·분류별 클릭 라우팅·'더 보기' 페이지네이션 — 2026-06-10. ⚠ settings 허브의 notification_settings_screen.dart는 미연동 mock 사본 — 정리 필요)
