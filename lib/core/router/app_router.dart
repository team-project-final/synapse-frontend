...
final appRouterProvider = Provider<GoRouter>((ref) {
  return GoRouter(initialLocation: AppRoutes.dashboard, routes: _routes);
});
...
final _routes = [
  ...
  GoRoute(path: AppRoutes.mfa, builder: (context, state) => const MfaScreen()),
  GoRoute(
  ...
  GoRoute(path: AppRoutes.qa, builder: (context, state) => const AiQaScreen()),
  GoRoute(
